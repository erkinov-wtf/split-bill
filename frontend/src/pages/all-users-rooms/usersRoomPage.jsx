...
import noRoom from "../../assets/download.png";
...
export default function UsersRoomPage() {
    ...
    return (
        <div className="flex">
            ...
            {/* Main Content */}
            <div className="p-6 ml-64 w-200 ">
                {/* Header */}
                <div className="flex justify-between items-center mb-4 sticky top-0 bg-white h-26 p-4 rounded-lg shadow-md ">
